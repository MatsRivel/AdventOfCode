mod p1{
    ...
    fn get_best_node(nodes:&HashMap<usize,Node>)->usize{
    ...
    pub fn main_1(file_name:&str)->Option<i32>{
        ...
        let mut data_iterator = get_data(&data_string);
        let mut nodes:HashMap<usize,Node> = data_iterator
            .map(|mut line| {
        ...
        while steps > 0{
            ...
            let best_node = get_best_node(&nodes);
